...
<!-- BEGIN tinyMCE -->
<script language="javascript" type="text/javascript" src="{tinyMCE.PATH}controller/mx_shared/tinymce/jscripts/tiny_mce/tiny_mce.js"></script>
<script language="javascript" type="text/javascript">
   tinyMCE.init({
      	mode : "textareas",
...
<!-- BEGIN tinyMCE_admin -->
<script language="javascript" type="text/javascript" src="{tinyMCE_admin.PATH}controller/mx_shared/tinymce/jscripts/tiny_mce/tiny_mce.js"></script>
<script language="javascript" type="text/javascript">
   tinyMCE.init({
		mode : "textareas",
