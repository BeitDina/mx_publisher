<script type="text/javascript" src="{MX_ROOT_PATH}{MODULE_ROOT_PATH}kb/includes/js/common.js"></script>
<script type="text/javascript" src="{MX_ROOT_PATH}{MODULE_ROOT_PATH}kb/shared/XulMenu/XulMenu.js"></script>
<script type="text/javascript" src="{MX_ROOT_PATH}{MODULE_ROOT_PATH}kb/shared/XulMenu/ie5.js"></script>
<script type="text/javascript" src="{MX_ROOT_PATH}{MODULE_ROOT_PATH}kb/shared/DynamicTree/DynamicTree.js"></script>
<script type="text/javascript" src="{MX_ROOT_PATH}{MODULE_ROOT_PATH}kb/shared/XulTabs/XulTabs.js"></script>

<script type="text/javascript" src="{MX_ROOT_PATH}{MODULE_ROOT_PATH}kb/includes/js/management.js.php"></script>
<script type="text/javascript" src="{MX_ROOT_PATH}{MODULE_ROOT_PATH}kb/includes/js/request.js.php"></script>
<script type="text/javascript" src="{MX_ROOT_PATH}{MODULE_ROOT_PATH}kb/includes/js/debug.js"></script>
...
function _mxBlock(id, page, start)
{
	this.block_id = id;
	this.page_id = page;
	this.start = start;
}
mxBlock = new _mxBlock('{BLOCK_ID}','{PAGE_ID}','{START}');
...
#articlewrap { padding:5px;}
#articlewrap .contents { float: right;  background-color: {T_TR_COLOR2}; padding: 0.75em; margin: 0 0 0.75em 0.75em; border: 1px solid {T_TH_COLOR1}; }
#articlewrap .contents ul { list-style: none; margin-left: 0.5em; margin-right: 0.1em; margin-bottom: 2px; margin-top: 0px; padding: 5px; text-indent: -0.9em; }
...
.DynamicTree .section { background: url({MX_ROOT_PATH}{MODULE_ROOT_PATH}kb/shared/DynamicTree/images/tree-branch.gif) repeat-y; display: none; }
...
.DynamicTree .wrap1 { padding: 10px; border: 1px solid {T_TH_COLOR1}; width: 150px; }
					    ...
					    <td>
					        ...
					        <tr>
					            <td id="left" class="rowxx">
					                ...
					                <script type="text/javascript">var tree = new DynamicTree("tree"); tree.path = "{MX_ROOT_PATH}{MODULE_ROOT_PATH}kb/shared/DynamicTree/images/"; tree.init();</script>
					                <script type="text/javascript" src="{MX_ROOT_PATH}{MODULE_ROOT_PATH}kb/includes/js/init_view.js"></script>
					            </td>
