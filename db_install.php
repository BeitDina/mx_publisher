...
$mx_module_version = '0.2.5-alpha';
$mx_module_copy = 'MX Projecs Module based on original phpBB <i>pafileDB</i> MOD by Mohd/Jon Ohlsson/Orynider</a> based on <a href="http://www.phparena.net/" target="_blank">PHP Arena, FlorinCB</a> :: Adapted for MX-Publisher by [Jon Ohlsson] <a href="http://www.mx-publisher.com" target="_blank">The MX-Publisher Development Team</a>';
...
if ( !$result = $db->sql_query( "SELECT config_name from " . $mx_table_prefix . "pub_config" ) )
{
	...
	$sql = array(
		...
		"DROP TABLE IF EXISTS " . $mx_table_prefix . "pub_config ",
		"DROP TABLE IF EXISTS " . $mx_table_prefix . "pub_custom ",
		"DROP TABLE IF EXISTS " . $mx_table_prefix . "pub_customdata ",
		"DROP TABLE IF EXISTS " . $mx_table_prefix . "pub_filesacces_info ",
		"DROP TABLE IF EXISTS " . $mx_table_prefix . "pub_license ",
		"DROP TABLE IF EXISTS " . $mx_table_prefix . "pub_types ",
		//"DROP TABLE IF EXISTS " . $mx_table_prefix . "pub_wordlist ",
		//"DROP TABLE IF EXISTS " . $mx_table_prefix . "pub_results ",
		//"DROP TABLE IF EXISTS " . $mx_table_prefix . "pub_wordmatch ",
		...
		"CREATE TABLE " . $mx_table_prefix . "pub_cat (
		  ...
		  `cat_articles` mediumint(8) NOT NULL default '-1',
		  ...
		  `auth_view_article` tinyint(2) NOT NULL default '0',
		  `auth_edit_article` tinyint(2) NOT NULL default '0',
		  `auth_delete_article` tinyint(2) NOT NULL default '2',
		...
		"CREATE TABLE " . $mx_table_prefix . "pub_files (
		...
		// --------------------------------------------------------
		// Table structure for table `phpbb_pub_custom`
		"CREATE TABLE " . $mx_table_prefix . "pub_custom (
		...
		"CREATE TABLE " . $mx_table_prefix . "pub_auth (
		...
		// General
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('enable_module', '1')", // settings_disable
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('module_name', 'Projects Database')", // settings_dbname
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('wysiwyg_path', 'modules/mx_shared/')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('upload_dir','publisher/uploads/')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('screenshots_dir','publisher/images/screenshots/')",

		// Files
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('max_file_size','10485760')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('forbidden_extensions','php, php5, php7, phtml, pl, asp, aspx, cgi')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('hotlink_prevent', '1')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('hotlink_allowed', '')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('tpl_php', '0')",
		
		// Articles
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('formatting_wordwrap', '1')", // formatting_fixup
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('formatting_image_resize', '300')", // NEW
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('formatting_truncate_links', '1')", // NEW
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('allow_wysiwyg', '0')", // NEW
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('allow_html', '1')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('allow_bbcode', '1')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('allow_smilies', '1')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('allowed_html_tags', 'b,i,u,a')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('allow_links', '1')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('allow_images', '0')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('no_image_message', '[No image please]')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('no_link_message', '[No links please]')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('max_subject_chars', '100')", // NEW
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('max_desc_chars', '500')", // NEW
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('max_chars', '0')", // NEW

		// Appearance
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('sort_method', 'article_date')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('sort_order', 'ASC')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('pagination', '10')", // art_pagination & settings_file_page

		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('settings_stats', '')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('settings_viewall', '1')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('settings_dbdescription', '')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('settings_topnumber', '10')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('header_banner', '0')",

		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('use_simple_navigation', '1')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('cat_col', '2')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('settings_newdays', '1')",

		// Comments
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('use_comments', '0')", // comments_show
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('internal_comments', '1')", // NEW
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('formatting_comment_wordwrap', '1')", // formatting_comment_fixup
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('formatting_comment_image_resize', '300')", // NEW
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('formatting_comment_truncate_links', '1')", // NEW
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('max_comment_subject_chars', '50')", // NEW
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('max_comment_chars', '5000')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('allow_comment_wysiwyg', '0')", // allow_wysiwyg_comments & allow_wysiwyg
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('allow_comment_html', '1')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('allow_comment_bbcode', '1')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('allow_comment_smilies', '1')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('allow_comment_links', '1')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('allow_comment_images', '0')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('no_comment_image_message', '[No image please]')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('no_comment_link_message', '[No links please]')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('allowed_comment_html_tags', 'b,i,u,a')", // NEW
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('del_topic', '1')", // NEW
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('autogenerate_comments', '1')",	// NEW
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('comments_pagination', '5')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('comments_forum_id', '0')", // New

		// Ratings
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('use_ratings', '0')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('votes_check_userid', '1')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('votes_check_ip', '1')",

		// Instructions
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('show_pretext', '0')", // NEW
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('pt_header', 'Article Submission Instructions')", // NEW
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('pt_body', 'Please check your references and include as much information as you can.')", // NEW

		// Notifications
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('notify', '0')", // pm_notify
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('notify_group', '0')",	// NEW

		// Permissions
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('auth_search','0')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('auth_stats','0')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('auth_toplist','0')",
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('auth_viewall','0')",
		
		//Screen Shots Settings  (Go Here)
		"INSERT INTO " . $mx_table_prefix . "pub_config (`config_name`, `config_value`) VALUES ('resize_ss', '0')", //To do (for security reasons to filter uploaded files using php GD extension)		
