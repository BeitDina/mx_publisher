...
* @version $Id: pub_license.php,v 1.23 2008/09/21 14:25:32 orynider Exp $
 ...
 *
 */
class publisher_license extends publisher_public
{
	/**
	 * Enter description here...
	 *
	...
	{
		global $template, $lang, $board_config, $phpEx, $publisher_config, $db, $images, $userdata;
		...
		$template->assign_vars( array(
			...
			'U_PROJECTS' => mx_append_sid( $this->this_mxurl( 'action=download&file_id=' . $file_id, 1 ) ),
		...
		$this->display( $lang['Download'], 'pub_license_body.tpl' );
	}
}
?>