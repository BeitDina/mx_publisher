...
* @version $Id: pub_lists.php,v 1.7 2008/09/17 05:09:00 orynider Exp $
 ...
 *
 */
class publisher_lists extends publisher_public
{
	/**
	 * Enter description here...
	 *
	...
	function main( $action  = false )
	{
		...
		// Request vars
		// =======================================================
		$start = $mx_request_vars->request('pub_start', MX_TYPE_INT, 0);
		...
		$tmp_pag = $publisher_config['pagination'];
		$publisher_config['pagination'] = $toplist_config['toplist_pagination'];
		...
		$publisher_config['pagination'] = $tmp_pag;

		$template->assign_vars( array(
			'U_PROJECTS' => mx_append_sid( $this->this_mxurl() ),
			'PROJECTS' => $publisher_config['module_name'],

			'BLOCK_PAGINATION' => mx_generate_pagination(mx_append_sid( $this->this_mxurl( '', false, false ) ), $total_num_items, $toplist_config['toplist_pagination'], $start, true, true, true, false, 'pub_start'),
		));
		...
		$this->display( $lang['Download'], 'pub_lists.tpl' );
	}
}
?>