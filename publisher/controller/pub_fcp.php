...
* @version $Id: pub_fcp.php,v 1.20 2008/09/21 14:25:33 orynider Exp $
 ...
 *
 */
class publisher_fcp extends publisher_public
{
	/**
	 * Enter description here...
	 *
	...
	function main($action = false)
	{
		...
		$this->display( $lang['FCP'], $template_item );
		$this->_publisher();
	}
}
?>