...
* @version $Id: pub_viewall.php,v 1.23 2008/09/21 14:25:40 orynider Exp $
 ...
 *
 */
class publisher_viewall extends publisher_public
{
	/**
	 * Enter description here...
	 *
	...
	function main($action = false)
	{
		...
		if ( !$publisher_config['settings_viewall'] )
		{
		...
		$this->display( $lang['Download'], 'pub_viewall_body.tpl' );
	}
}
?>